...
class chebCommentDialogVC: UIViewController, UITextViewDelegate
{
    var currentCheckBox : Model_CheckBox!
    ...
    func customInit()
    {
        ...
        previousString = currentCheckBox.commentStr
        
        let commentV = currentCheckBox.commentView!
        let rootView = currentCheckBox.auditView!
        ...
        okButton.click =
            {
                ...
                if self.text == self.placeHolder || self.text == ""
                {
                    ...
                    self.currentCheckBox.commentStr = nil
                ...
                if self.text != nil
                {
                    ...
                    self.currentCheckBox.commentStr = self.text
        ...
        if currentCheckBox.commentStr != nil
        {
            commentTextView.text = currentCheckBox.commentStr!
    ...
    init(cheb : Model_CheckBox)
    {
        super.init(nibName: nil, bundle: nil)
        currentCheckBox = cheb
        customInit()
    }
